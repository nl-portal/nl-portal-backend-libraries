...
data class BrpOuder(
    ...
    val datumIngangFamilierechtelijkeBetrekking: BrpDatum? = null,
    val inOnderzoek: BrpOuderInOnderzoek? = null,
    val naam: BrpNaam? = null,
    val geboorte: BrpDatumLandPlaats? = null,
)

data class BrpOuderInOnderzoek(
    val datumIngangOnderzoek: BrpDatum? = null,
    val burgerservicenummer: Boolean? = false,
    val geslacht: Boolean? = false,
    val datumIngangFamilierechtelijkeBetrekking: Boolean? = false,
)