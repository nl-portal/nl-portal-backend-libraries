...
data class BrpImigratie(
    val datumVestigingInNederland: BrpDatum? = null,
...
data class BrpImigratieInOnderzoek(
    ...
    val datumVestigingInNederland: Boolean? = false,
    val landVanwaarIngeschreven: Boolean? = false,
    val vanuitVerblijfplaatsOnbekend: Boolean? = false,
    val indicatieVestigingVanuitBuitenland: Boolean? = false,
)