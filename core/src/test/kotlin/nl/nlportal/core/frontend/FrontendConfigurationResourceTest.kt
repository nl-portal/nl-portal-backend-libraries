...
class FrontendConfigurationResourceTest(
    ...
    @Autowired private val coreThemeConfiguration: CoreThemeConfigurationProperties,
) {
    @Test
    fun `get style`() {
        ...
        assertEquals(coreThemeConfiguration.style, responseBodyContent)
    }
    ...
    fun `get logo`() {
        ...
        assertEquals(coreThemeConfiguration.logo, responseBodyContent)
    }
}
