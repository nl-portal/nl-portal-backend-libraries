...
import nl.nlportal.form.startform.graphql.CreateStartFormMutation
import nl.nlportal.form.startform.graphql.StartFormQuery
import nl.nlportal.form.startform.service.StartFormService
import org.springframework.boot.autoconfigure.AutoConfiguration
import org.springframework.context.annotation.Bean

@AutoConfiguration
class FormGraphqlAutoConfiguration {
    @Bean
    fun startFromQuery(
