...
class ProductTestConfiguration {
    ...
    @Value("classpath:product/graphql/getProductZakenNoZaakTypes.graphql")
    private lateinit var getProductZakenNoZaakTypes: Resource
    ...
    @Value("classpath:product/graphql/productPrefill.graphql")
    private lateinit var productPrefill: Resource
