...
import nl.nlportal.openklant.graphql.VerificatieMutation
...
class OpenKlantGraphqlAutoConfiguration {
    ...
    fun verificatieMutation(openKlantVerificatieService: OpenKlantVerificatieService): VerificatieMutation = VerificatieMutation(openKlantVerificatieService)
}