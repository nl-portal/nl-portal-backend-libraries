...
enum class OpenProductProductTypesFilters(
    ...
    LETTERS("letter"),
    PARAMETER("parameter"),
    PROCESS_URL("processen__url"),
    PROCESS_URL_CONTAINS("processen__url__contains"),
    PROCESS_URN("processen__urn"),
    PROCESS_URN_CONTAINS("processen__urn__contains"),
    ...
    VERZOEKTYPE_URL("verzoektypen__url"),
    VERZOEKTYPE_URL_CONTAINS("verzoektypen__url__contains"),
    VERZOEKTYPE_URN("verzoektypen__urn"),
    VERZOEKTYPE_URN_CONTAINS("verzoektypen__urn__contains"),
    ZAAKTYPE_URL("zaaktypen__url"),
    ZAAKTYPE_URL_CONTAINS("zaaktypen__url__contains"),
    ZAAKTYPE_URN("zaaktypen__urn"),
    ZAAKTYPE_URN_CONTAINS("zaaktypen__urn__contains"),
