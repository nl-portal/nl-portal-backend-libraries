...
enum class OpenProductProductenFilters(
    ...
    AANMAAK_ZAAK_URL("aanvraag_zaak_url"),
    AANMAAK_ZAAK_URL_CONTAINS("aanvraag_zaak_url__contains"),
    AANMAAK_ZAAK_URN("aanvraag_zaak_urn"),
    AANMAAK_ZAAK_URN_CONTAINS("aanvraag_zaak_urn__contains"),
    ...
    PRODUCTTYPE_PUBLISHED("producttype__gepubliceerd"),
    ...
    ZAKEN_URL("zaken__url"),
    ZAKEN__URL_CONTAINS("zaken__url__contains"),
    ZAKEN__URN("zaken__urn__contains"),
    ZAKEN__URN_CONTAINS("zaken__urn"),
    ;
