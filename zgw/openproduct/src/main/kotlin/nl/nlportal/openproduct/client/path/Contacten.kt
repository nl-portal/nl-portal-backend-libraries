...
class Contacten(
    ...
    override val path: String = "/contacten/"

    suspend fun get(searchFilters: List<Pair<OpenProductContactenFilters, Any>>? = null): ResultPage<OpenProductContact> =
        client
            .webClient
            .get()
            .uri { uriBuilder ->
    ...
    suspend fun get(id: UUID): OpenProductContact? =
        client
            .webClient
            .get()
            .uri { uriBuilder ->
