...
class Acties(
    ...
    override val path: String = "/acties/"

    suspend fun get(searchFilters: List<Pair<OpenProductActiesFilters, Any>>? = null): ResultPage<OpenProductActie> {
        return client
            .webClient
            .get()
            .uri { uriBuilder ->
    ...
    suspend fun get(id: UUID): OpenProductActie? {
        return client
            .webClient
            .get()
            .uri { uriBuilder ->
