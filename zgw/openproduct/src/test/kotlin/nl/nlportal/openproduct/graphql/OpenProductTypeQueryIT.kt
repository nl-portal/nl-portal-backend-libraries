...
class OpenProductTypeQueryIT(
    ...
    fun `get product types`() =
        runTest {
            val basePath = "$.data.getOpenProductTypes"
            ...
            webTestClient
                ...
                .body(BodyInserters.fromResource(ClassPathResource("/config/graphql/getOpenProductTypes.gql")))
                .exchange()
                ...
                .isEqualTo("Parkeren")
                .jsonPath("$resultPath.uniformeProductNaam")
                .isEqualTo("Parkeervergunning")
                .jsonPath("$resultPath.code")
                .isEqualTo("PARKEREN")
                .jsonPath("$resultPath.themas[0].naam")
                .isEqualTo("Parkeren")
                .jsonPath("$resultPath.prijzen[0].uuid")
                .isEqualTo("317ab929-5cb4-4dde-ae4a-489f4d388699")
                .jsonPath("$resultPath.prijzen[0].prijsopties[0].bedrag")
                .isEqualTo(100.00)
                .jsonPath(
                    "$resultPath.prijzen[0].prijsregels[0].url",
                ).isEqualTo("http://localhost:9000/engine-rest/decision-definition/key/alg-belastingen")
                .jsonPath("$resultPath.links[0].naam")
                .isEqualTo("link naar Ritense website")
                .jsonPath("$resultPath.acties[0].naam")
                .isEqualTo("watkanikregelen-belastingen")
                .jsonPath(
                    "$resultPath.acties[0].url",
                ).isEqualTo("http://localhost:9000/engine-rest/decision-definition/key/alg-belastingen")
                .jsonPath("$resultPath.externCodes[0].code")
                .isEqualTo("RMWA")
                .jsonPath("$resultPath.parameters[0].naam")
                .isEqualTo("paymentcategorie")
                .jsonPath("$resultPath.parameters[0].waarde")
                .isEqualTo("parkeren")
                .jsonPath(
    ...
    fun `get product type`() =
        runTest {
            val basePath = "$.data.getOpenProductType"
            webTestClient
                .post()
                .uri { builder ->
                    builder
                ...
                .body(BodyInserters.fromResource(ClassPathResource("/config/graphql/getOpenProductType.gql")))
                .exchange()
                .verifyOnlyDataExists(basePath)
                .jsonPath("$basePath.naam")
                .isEqualTo("Parkeren")
                .jsonPath("$basePath.uniformeProductNaam")
                .isEqualTo("Parkeervergunning")
                .jsonPath("$basePath.code")
                .isEqualTo("PARKEREN")
                .jsonPath("$basePath.themas[0].naam")
                .isEqualTo("Parkeren")
                .jsonPath("$basePath.prijzen[0].uuid")
                .isEqualTo("317ab929-5cb4-4dde-ae4a-489f4d388699")
                .jsonPath("$basePath.prijzen[0].prijsopties[0].bedrag")
                .isEqualTo(100.00)
                .jsonPath(
                    "$basePath.prijzen[0].prijsregels[0].url",
                ).isEqualTo("http://localhost:9000/engine-rest/decision-definition/key/alg-belastingen")
                .jsonPath("$basePath.links[0].naam")
                .isEqualTo("link naar Ritense website")
                .jsonPath("$basePath.acties[0].naam")
                .isEqualTo("watkanikregelen-belastingen")
                .jsonPath(
                    "$basePath.acties[0].url",
                ).isEqualTo("http://localhost:9000/engine-rest/decision-definition/key/alg-belastingen")
                .jsonPath("$basePath.externCodes[0].code")
                .isEqualTo("RMWA")
                .jsonPath("$basePath.parameters[0].naam")
                .isEqualTo("paymentcategorie")
                .jsonPath("$basePath.parameters[0].waarde")
                .isEqualTo("parkeren")
                .jsonPath(
