...
class OpenProductOrganisatieQueryIT(
    ...
    fun `get organisaties`() =
        runTest {
            val responseBody =
                httpGraphQlTester
                    .document(readFileAsString("/config/graphql/getOpenProductOrganisaties.gql"))
                    .execute()
                    .errors()
                    .verify()
                    .path("getOpenProductOrganisaties")
    ...
    fun `get organisatie`() =
        runTest {
            val responseBody =
                httpGraphQlTester
                    .document(readFileAsString("/config/graphql/getOpenProductOrganisatie.gql"))
                    .execute()
                    .errors()
                    .verify()
                    .path("getOpenProductOrganisatie")
                    .entity(JsonNode::class.java)
                    .get()
