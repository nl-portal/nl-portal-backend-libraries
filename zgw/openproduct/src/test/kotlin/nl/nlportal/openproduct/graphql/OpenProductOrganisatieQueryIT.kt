...
class OpenProductOrganisatieQueryIT(
    ...
    fun `get organisaties`() =
        runTest {
            val basePath = "$.data.getOpenProductOrganisaties"
            ...
            webTestClient
                ...
                .body(BodyInserters.fromResource(ClassPathResource("/config/graphql/getOpenProductOrganisaties.gql")))
                .exchange()
    ...
    fun `get organisatie`() =
        runTest {
            val basePath = "$.data.getOpenProductOrganisatie"
            webTestClient
                .post()
                .uri { builder ->
                    builder
                ...
                .body(BodyInserters.fromResource(ClassPathResource("/config/graphql/getOpenProductOrganisatie.gql")))
                .exchange()
                .verifyOnlyDataExists(basePath)
